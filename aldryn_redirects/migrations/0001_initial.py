    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='redirects_hvad_set', to='sites.Site')),
            ],
            options={
                'ordering': ('old_path',),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='translations', editable=False, to='aldryn_redirects.Redirect', null=True)),
            ],
            options={
                'managed': True,
                'abstract': False,
